    ...
    $cordovaEmailComposer.isAvailable().then(function() {
      // is available
        $cordovaEmailComposer.open({
          to: 'kicet@kicet.re.kr',
          cc: 'stackgo@databean.co.kr',
          subject: 'Contact from KICET App',
          body: 'How are you? Nice greetings from Republic of Korea'
        })
        .then(null, function () {
...
.controller('WebsiteCtrl', function($scope) {
  $scope.goToWebsite = function() {
    window.open("https://bit.ly/2ya5FLQ", "_system");
  };
})
